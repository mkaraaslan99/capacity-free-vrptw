...
\textbf{export\_report\_tables.py} -- Exports formatted tables from experimental results for inclusion in research reports.

\textbf{plot\_detailed\_runs\_figures.py} -- Creates visualization figures including cost distributions, runtime analysis, and route count plots.
